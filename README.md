...
[![GoDoc](https://godoc.org/github.com/cleancluster/goja?status.svg)](https://godoc.org/github.com/cleancluster/goja)
 ...
 * Sourcemaps.
 * Some ES6 functionality, still work in progress, see https://github.com/cleancluster/goja/milestone/1?closed=1
...
You can find some benchmarks [here](https://github.com/cleancluster/goja/issues/2).
...
There is a [separate project](https://github.com/cleancluster/goja_nodejs) aimed at providing some NodeJS functionality,
...
See https://github.com/cleancluster/goja/milestone/1 for more details.
...
for ETAs. Features that are open in the [milestone](https://github.com/cleancluster/goja/milestone/1) are either in progress
...
--------------------
Any Go value can be passed to JS using Runtime.ToValue() method. See the method's [documentation](https://godoc.org/github.com/cleancluster/goja#Runtime.ToValue) for more details.

Exporting Values from JS
------------------------
A JS value can be exported into its default Go representation using Value.Export() method.

Alternatively it can be exported into a specific Go variable using [Runtime.ExportTo()](https://godoc.org/github.com/cleancluster/goja#Runtime.ExportTo) method.
...
- Using [AssertFunction()](https://godoc.org/github.com/cleancluster/goja#AssertFunction):
```go
vm := New()
_, err := vm.RunString(`
function sum(a, b) {
...
// Output: 42
```
- Using [Runtime.ExportTo()](https://godoc.org/github.com/cleancluster/goja#Runtime.ExportTo):
```go
const SCRIPT = `
function f(param) {
    return +param + 2;
...
dealing with a 3rd party library, you can use a [FieldNameMapper](https://godoc.org/github.com/cleancluster/goja#FieldNameMapper):
...
There are two standard mappers: [TagFieldNameMapper](https://godoc.org/github.com/cleancluster/goja#TagFieldNameMapper) and
[UncapFieldNameMapper](https://godoc.org/github.com/cleancluster/goja#UncapFieldNameMapper), or you can use your own implementation.
...
There is a [separate project](https://github.com/cleancluster/goja_nodejs) aimed at providing some of the NodeJS functionality.
